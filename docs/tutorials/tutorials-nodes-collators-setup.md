...
DataHighway discord has a dedicated channel for any collators questions. Join our discord and head on to the :cyclone: -collators-:cyclone: channel, in the Support category. 

To join our discord, simply go to Datahighway.com(http://datahighway.com) and scroll down until you see the discord logo. Click on it and become a member of the DataHighway familly.
